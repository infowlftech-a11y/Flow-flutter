...
abstract final class FlowConst {
  ...
  /// Ticket topics (closed list) — P9, beside [reportReasons] because it is
  /// the same kind of vocabulary: the first thing support triages by, picked
  /// by the user instead of inferred from prose.
  static const ticketTopics = [
    'Payment or refund',
    'Booking problem',
    'Safety',
    'Account & profile',
